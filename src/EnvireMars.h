...
// We will need this later most likely
//#include <mars/utils/Mutex.h>

/*
 * The interfaces will be implemented in the Mars Core, here only the main
 * class is programmed.
 */

// First we do a dummy class and implement the inheritance of NodeManager to it
namespace envireMars{
